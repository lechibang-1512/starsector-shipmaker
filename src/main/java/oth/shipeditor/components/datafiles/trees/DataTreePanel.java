...
public abstract class DataTreePanel extends JPanel {
    ...
    private static JPanel createTableButtons(CSVEntry entry) {
        ...
        saveCsvButton.addActionListener(e -> oth.shipeditor.communication.EventBus.publish(
                new oth.shipeditor.communication.events.files.saving.CSVSaveQueued(entry)
        ));
