...
public class SlotDataControlPane extends AbstractSlotValuesPanel {
    ...
    private JPanel createBuiltInFeaturePanel() {
        ...
        oth.shipeditor.utility.components.ComponentUtilities.outfitPanelWithTitle(panel, "Built-In Feature");
        ...
        actionButton.addActionListener(e -> {
            ...
            if (layer instanceof ShipLayer shipLayer) {
                if (hasFeature) {
                    ...
                    oth.shipeditor.components.datafiles.entities.WeaponCSVEntry picked = oth.shipeditor.utility.components.dialog.DialogUtilities
