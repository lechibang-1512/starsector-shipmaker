...
class SuppressedModsPanel extends JPanel {
    ...
    private void syncBackToVariant() {
        ViewerLayer activeLayer = oth.shipeditor.utility.overseers.StaticController.getActiveLayer();
        ...
        oth.shipeditor.undo.edits.features.SuppressedModsEdit edit = new oth.shipeditor.undo.edits.features.SuppressedModsEdit(variant, activeLayer, oldList, updatedList);
        oth.shipeditor.undo.UndoOverseer.post(edit);
        edit.redo();
    }
