...
public final class ViewerLayersPanel extends SortableTabbedPane {
    ...
    private void initLayerListeners() {
        EventBus.subscribe(this, event -> {
            ...
            else if (event instanceof oth.shipeditor.communication.events.viewer.layers.weapons.ProjectileLayerCreated checked) {
                oth.shipeditor.components.viewer.layers.weapon.ProjectileLayer layer = checked.newLayer();
    ...
    private void handleTabUpdates(ViewerLayer eventLayer) {
        ...
        } else if (updated instanceof ProjectileLayerTab checkedProjectileTab && eventLayer instanceof oth.shipeditor.components.viewer.layers.weapon.ProjectileLayer checkedLayer) {
            this.updateProjectileTab(checkedProjectileTab, checkedLayer);
        }
    }

    private void updateProjectileTab(ProjectileLayerTab tab, oth.shipeditor.components.viewer.layers.weapon.ProjectileLayer layer) {
    ...
    class TabContextListener extends MouseAdapter {
        ...
        private static JMenuItem createPrintLayerOption(ViewerLayer layer) {
            ...
            printLayer.addActionListener(event -> {
                ...
                int returnVal = chooser.showSaveDialog(oth.shipeditor.PrimaryWindow.getInstance());
                ...
                if (returnVal == JFileChooser.APPROVE_OPTION) {
                    ...
                    try {
                        ...
                        log.error("Layer printing failed", e);
