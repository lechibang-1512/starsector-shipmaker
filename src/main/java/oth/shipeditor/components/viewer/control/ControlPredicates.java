...
public final class ControlPredicates {
    ...
    public static final Predicate<MouseEvent> changeAnglePredicate = Predicates.and(
            InputEventPredicates.buttonDown(1),
            InputEventPredicates.altDown()
    );

    public static final Predicate<MouseEvent> changeArcOrSizePredicate = Predicates.and(
            InputEventPredicates.buttonDown(3),
            InputEventPredicates.altDown()
    );
