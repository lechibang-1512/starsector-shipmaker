...
public final class ShipSkin {
    ...
    public Sprite getLoadedSkinSprite() {
        if (loadedSkinSprite == null) {
            ...
            java.io.File skinSpriteFile = oth.shipeditor.parsing.loading.FileLoading.fetchDataFile(skinSpriteFilePath, skinPackagePath);

            loadedSkinSprite = oth.shipeditor.parsing.loading.FileLoading.loadSprite(skinSpriteFile);
        }
    ...
    @SuppressWarnings({"PublicInnerClass", "ClassWithTooManyMethods",
            "MethodParameterNamingConvention", "WeakerAccess"})
