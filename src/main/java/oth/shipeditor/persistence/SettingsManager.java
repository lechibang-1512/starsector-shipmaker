...
public final class SettingsManager {
    ...
    @Getter
    private static final String projectVersion = "0.0.1c";
    ...
    public static Path getFolderForModId(String modId) {
        ...
        if ("starsector-core".equals(modId) || isCoreFolder(corePath)) {
            if (corePath.getFileName().toString().equals(modId) || "starsector-core".equals(modId)) {
                return corePath;
            }
        }
        ...
        for (Path modFolder : getAllModFolders()) {
            if (modFolder.getFileName().toString().equals(modId)) {
                return modFolder;
            }
        }
        return null;
