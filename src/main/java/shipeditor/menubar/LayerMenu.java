...
class LayerMenu extends JMenu {
    ...
    void initialize() {
        ...
        JMenuItem centerLayer = new JMenuItem("Center View on Layer");
        centerLayer.setIcon(FontIcon.of(BoxiconsRegular.TARGET_LOCK, 16, Themes.getIconColor()));
        centerLayer.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_0, InputEvent.CTRL_DOWN_MASK));
        centerLayer.addActionListener(e -> EventBus.publish(new ViewerTransformsReset()));
        this.add(centerLayer);
    }
}
